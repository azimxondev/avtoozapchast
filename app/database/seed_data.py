...
def get_105_products():
    raw_products = [
        ...
        ("Nexia 1 / 2 Yon Ko'zgusi (Bakavoy Oyna, Chap)", "BODY-NEX1-MRR-L", "body-parts", "UzAuto Parts", "Daewoo", "Nexia 1, Nexia 2", "1996-2016", "Mexanik sozlanuvchi yon ko'zgu (Bakavoy)", "https://images.unsplash.com/photo-1502877338535-766e1452684a?w=600", "NEW", 120000, 180000, 8, 2, "dona", "K-08B"),
        ("Nexia 1 / 2 Yon Ko'zgusi (Bakavoy Oyna, O'ng)", "BODY-NEX1-MRR-R", "body-parts", "UzAuto Parts", "Daewoo", "Nexia 1, Nexia 2", "1996-2016", "Mexanik sozlanuvchi yon ko'zgu (Bakavoy)", "https://images.unsplash.com/photo-1502877338535-766e1452684a?w=600", "NEW", 120000, 180000, 7, 2, "dona", "K-08B"),
        ...
        # --- TRANSMISSIYA (10) ---
        ("Cobalt Ssepleniye Disk va Korzina (Valeo Korea)", "TRN-COB-VALEO", "transmission", "Valeo", "Chevrolet", "Cobalt Mexanika", "2013-2024", "Yumshoq bosiluvchi original komplekt", "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=600", "NEW", 680000, 920000, 5, 2, "to'plam", "U-01"),
        ("Gentra Vжимnoy Podshipnik (Gidravlik)", "TRN-GEN-CSC", "transmission", "Valeo", "Chevrolet", "Gentra, Lacetti", "2013-2024", "Gidravlik silindrli vijimnoy", "https://images.unsplash.com/photo-1486006920555-c77dce18193b?w=600", "NEW", 280000, 410000, 7, 2, "dona", "U-02"),
        ("Cobalt Tashqi Granata (SHRUS, CTR)", "TRN-COB-CV-OUT", "transmission", "CTR", "Chevrolet", "Cobalt ABS", "2013-2024", "Pylnik va moyi bilan komplekt", "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=600", "NEW", 220000, 320000, 9, 3, "to'plam", "U-03"),
        ("Nexia 3 Ichki Granata (SHRUS, Triploid)", "TRN-NEX3-CV-IN", "transmission", "UzAuto Parts", "Chevrolet", "Nexia 3 Avtomat", "2016-2023", "Kopir naychali ichki granata", "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=600", "NEW", 240000, 350000, 6, 2, "to'plam", "U-04"),
        ...
        ("Spark Ssepleniye Trosi (Zavod)", "TRN-SPK-CBL", "transmission", "UzAuto Parts", "Chevrolet", "Spark Mexanika", "2010-2022", "Mustahkam trosik", "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=600", "NEW", 65000, 105000, 12, 3, "dona", "U-06"),
        ("Damas Kardanchik Krestovina", "TRN-DAM-CRSS", "transmission", "GMB Korea", "Chevrolet", "Damas, Labo", "1996-2024", "Kardan mili krestovinasi", "https://images.unsplash.com/photo-1486006920555-c77dce18193b?w=600", "NEW", 55000, 85000, 18, 4, "dona", "U-07"),
        ("Cobalt Korobka Kulisa Tyagasi", "TRN-COB-KUL", "transmission", "UzAuto Parts", "Chevrolet", "Cobalt", "2013-2024", "Tezlikni aniq ulovchi richag", "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=600", "NEW", 120000, 180000, 7, 2, "dona", "U-08"),
        ("Gentra Ssepleniye Bosh Silindri", "TRN-GEN-CYL", "transmission", "Brembo", "Chevrolet", "Gentra", "2013-2024", "Pedal osti gidrotsilindr", "https://images.unsplash.com/photo-1486006920555-c77dce18193b?w=600", "NEW", 145000, 215000, 6, 2, "dona", "U-09"),
